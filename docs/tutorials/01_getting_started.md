...
## Terminology: ONN, dONN, and oNeura
...
| **dONN** | **digital Organic Neural Network** — oNeura's biophysically faithful *simulation* of an ONN, running on GPU or CPU. Every neuron has Hodgkin-Huxley ion channels, real neurotransmitters, gene expression, and STDP — so behaviors like learning, drug response, and consciousness *emerge* from molecular dynamics rather than being programmed. |
| **oNeura** | The software platform you're learning in this tutorial. It's the tool for building, running, and experimenting with dONNs. |
