...
impl ClimateEngine {
    ...
    fn mean_co2(&self, year: f64) -> f64 {
        ...
        if self.params.co2_ppm_trend_per_decade > 0.0 && self.params.co2_ppm_trend_per_decade < 15.0
        {
    ...
    pub fn run_projection(&mut self, start_year: f64, end_year: f64, dt: f64) -> ClimateTimeSeries {
    ...
    /// Override the internal simulation year without advancing the weather RNG.
    pub fn set_current_year(&mut self, year: f64) {
...
mod tests {
    ...
    fn rcp85_severe_warming() {
        ...
        let warming_26 =
            engine26.state_at(2100.5).temperature_c - engine26.state_at(1995.5).temperature_c;
        assert!(
