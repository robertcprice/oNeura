...
use super::{TerrariumWorld, TerrariumWorldConfig, TerrariumWorldSnapshot};
...
impl WorldGenome {
    ...
    pub fn random(rng: &mut StdRng) -> Self {
        Self {
            initial_proton_scale: rng
                .gen_range(GenomeRange::PROTON_SCALE.0..=GenomeRange::PROTON_SCALE.1),
            soil_temperature_c: rng
                .gen_range(GenomeRange::TEMPERATURE.0..=GenomeRange::TEMPERATURE.1),
            water_source_count: rng
                .gen_range(GenomeRange::WATER_COUNT.0..=GenomeRange::WATER_COUNT.1),
            water_volume: rng.gen_range(GenomeRange::WATER_VOLUME.0..=GenomeRange::WATER_VOLUME.1),
            initial_moisture_scale: rng
                .gen_range(GenomeRange::MOISTURE_SCALE.0..=GenomeRange::MOISTURE_SCALE.1),
            ...
            microbe_cohort_count: rng
                .gen_range(GenomeRange::MICROBE_COUNT.0..=GenomeRange::MICROBE_COUNT.1),
            fly_psc_scale: rng.gen_range(GenomeRange::PSC_SCALE.0..=GenomeRange::PSC_SCALE.1),
            fly_neural_steps: rng
                .gen_range(GenomeRange::NEURAL_STEPS.0..=GenomeRange::NEURAL_STEPS.1),
            fly_scale: rng.gen_range(GenomeRange::FLY_SCALE.0..=GenomeRange::FLY_SCALE.1),
            respiration_vmax_scale: rng
                .gen_range(GenomeRange::VMAX_SCALE.0..=GenomeRange::VMAX_SCALE.1),
            nitrification_vmax_scale: rng
                .gen_range(GenomeRange::VMAX_SCALE.0..=GenomeRange::VMAX_SCALE.1),
            photosynthesis_vmax_scale: rng
                .gen_range(GenomeRange::VMAX_SCALE.0..=GenomeRange::VMAX_SCALE.1),
            mineralization_vmax_scale: rng
                .gen_range(GenomeRange::VMAX_SCALE.0..=GenomeRange::VMAX_SCALE.1),
            seed: rng.gen(),
    ...
    pub fn normalized_params(&self) -> Vec<f32> {
        ...
        vec![
            norm(
                self.initial_proton_scale,
                GenomeRange::PROTON_SCALE.0,
                GenomeRange::PROTON_SCALE.1,
            ),
            norm(
                self.soil_temperature_c,
                GenomeRange::TEMPERATURE.0,
                GenomeRange::TEMPERATURE.1,
            ),
            norm_usize(
                self.water_source_count,
                GenomeRange::WATER_COUNT.0,
                GenomeRange::WATER_COUNT.1,
            ),
            norm(
                self.water_volume,
                GenomeRange::WATER_VOLUME.0,
                GenomeRange::WATER_VOLUME.1,
            ),
            norm(
                self.initial_moisture_scale,
                GenomeRange::MOISTURE_SCALE.0,
                GenomeRange::MOISTURE_SCALE.1,
            ),
            norm_usize(
                self.plant_count,
                GenomeRange::PLANT_COUNT.0,
                GenomeRange::PLANT_COUNT.1,
            ),
            norm_usize(
                self.fruit_count,
                GenomeRange::FRUIT_COUNT.0,
                GenomeRange::FRUIT_COUNT.1,
            ),
            norm_usize(
                self.fly_count,
                GenomeRange::FLY_COUNT.0,
                GenomeRange::FLY_COUNT.1,
            ),
            norm_usize(
                self.microbe_cohort_count,
                GenomeRange::MICROBE_COUNT.0,
                GenomeRange::MICROBE_COUNT.1,
            ),
            norm(
                self.fly_psc_scale,
                GenomeRange::PSC_SCALE.0,
                GenomeRange::PSC_SCALE.1,
            ),
            norm(
                self.fly_neural_steps as f32,
                GenomeRange::NEURAL_STEPS.0 as f32,
                GenomeRange::NEURAL_STEPS.1 as f32,
            ),
            self.fly_scale as f32,
            norm(
                self.respiration_vmax_scale,
                GenomeRange::VMAX_SCALE.0,
                GenomeRange::VMAX_SCALE.1,
            ),
            norm(
                self.nitrification_vmax_scale,
                GenomeRange::VMAX_SCALE.0,
                GenomeRange::VMAX_SCALE.1,
            ),
            norm(
                self.photosynthesis_vmax_scale,
                GenomeRange::VMAX_SCALE.0,
                GenomeRange::VMAX_SCALE.1,
            ),
            norm(
                self.mineralization_vmax_scale,
                GenomeRange::VMAX_SCALE.0,
                GenomeRange::VMAX_SCALE.1,
            ),
            ...
            norm(
                self.time_warp,
                GenomeRange::TIME_WARP.0,
                GenomeRange::TIME_WARP.1,
            ),
            norm(
                self.enzyme_probe_x,
                GenomeRange::ENZYME_POS.0,
                GenomeRange::ENZYME_POS.1,
            ),
            norm(
                self.enzyme_probe_y,
                GenomeRange::ENZYME_POS.0,
    ...
    pub fn crossover(a: &Self, b: &Self, rng: &mut StdRng) -> Self {
        Self {
            initial_proton_scale: if rng.gen::<f32>() < 0.5 {
                a.initial_proton_scale
            } else {
                b.initial_proton_scale
            },
            soil_temperature_c: if rng.gen::<f32>() < 0.5 {
                a.soil_temperature_c
            } else {
                b.soil_temperature_c
            },
            water_source_count: if rng.gen::<f32>() < 0.5 {
                a.water_source_count
            } else {
                b.water_source_count
            },
            water_volume: if rng.gen::<f32>() < 0.5 {
                a.water_volume
            } else {
                b.water_volume
            },
            initial_moisture_scale: if rng.gen::<f32>() < 0.5 {
                a.initial_moisture_scale
            } else {
                b.initial_moisture_scale
            },
            plant_count: if rng.gen::<f32>() < 0.5 {
                a.plant_count
            } else {
                b.plant_count
            },
            fruit_count: if rng.gen::<f32>() < 0.5 {
                a.fruit_count
            } else {
                b.fruit_count
            },
            fly_count: if rng.gen::<f32>() < 0.5 {
                a.fly_count
            } else {
                b.fly_count
            },
            microbe_cohort_count: if rng.gen::<f32>() < 0.5 {
                a.microbe_cohort_count
            } else {
                b.microbe_cohort_count
            },
            fly_psc_scale: if rng.gen::<f32>() < 0.5 {
                a.fly_psc_scale
            } else {
                b.fly_psc_scale
            },
            fly_neural_steps: if rng.gen::<f32>() < 0.5 {
                a.fly_neural_steps
            } else {
                b.fly_neural_steps
            },
            fly_scale: if rng.gen::<f32>() < 0.5 {
                a.fly_scale
            } else {
                b.fly_scale
            },
            respiration_vmax_scale: if rng.gen::<f32>() < 0.5 {
                a.respiration_vmax_scale
            } else {
                b.respiration_vmax_scale
            },
            nitrification_vmax_scale: if rng.gen::<f32>() < 0.5 {
                a.nitrification_vmax_scale
            } else {
                b.nitrification_vmax_scale
            },
            photosynthesis_vmax_scale: if rng.gen::<f32>() < 0.5 {
                a.photosynthesis_vmax_scale
            } else {
                b.photosynthesis_vmax_scale
            },
            mineralization_vmax_scale: if rng.gen::<f32>() < 0.5 {
                a.mineralization_vmax_scale
            } else {
                b.mineralization_vmax_scale
            },
            seed: rng.gen(),
            time_warp: if rng.gen::<f32>() < 0.5 {
                a.time_warp
            } else {
                b.time_warp
            },
            enzyme_probe_x: if rng.gen::<f32>() < 0.5 {
                a.enzyme_probe_x
            } else {
                b.enzyme_probe_x
            },
            enzyme_probe_y: if rng.gen::<f32>() < 0.5 {
                a.enzyme_probe_y
            } else {
                b.enzyme_probe_y
            },
    ...
    pub fn mutate(&mut self, rng: &mut StdRng, rate: f32) {
        ...
        mutate_f32(
            &mut self.initial_moisture_scale,
            GenomeRange::MOISTURE_SCALE.0,
            GenomeRange::MOISTURE_SCALE.1,
            rng,
            rate,
        ...
        );
        {
            ...
            mutate_usize(
                &mut v,
                GenomeRange::NEURAL_STEPS.0 as usize,
                GenomeRange::NEURAL_STEPS.1 as usize,
                rng,
                rate,
            );
        ...
        mutate_f32(
            &mut self.respiration_vmax_scale,
            GenomeRange::VMAX_SCALE.0,
            GenomeRange::VMAX_SCALE.1,
            rng,
            rate,
        ...
        mutate_f32(
            &mut self.nitrification_vmax_scale,
            GenomeRange::VMAX_SCALE.0,
            GenomeRange::VMAX_SCALE.1,
            rng,
            rate,
        ...
        mutate_f32(
            &mut self.photosynthesis_vmax_scale,
            GenomeRange::VMAX_SCALE.0,
            GenomeRange::VMAX_SCALE.1,
            rng,
            rate,
        ...
        mutate_f32(
            &mut self.mineralization_vmax_scale,
            GenomeRange::VMAX_SCALE.0,
            GenomeRange::VMAX_SCALE.1,
            rng,
            rate,
...
pub fn evaluate_fitness(
    ...
    _periodic: &[TerrariumWorldSnapshot],
) -> f32 {
    match objective {
        ...
        FitnessObjective::MaxFruitProduction => snapshot.fruits as f32,
        FitnessObjective::MaxMicrobialHealth => snapshot.mean_microbes + snapshot.mean_symbionts,
        ...
        FitnessObjective::MaxEnzymeEfficacy => {
            ...
            let probe_stability = if snapshot.atomistic_probes > 0 {
                5.0
            } else {
                0.0
            };
        ...
        FitnessObjective::MaxEcosystemIntegrity => {
            ...
            let nutrient_cycling =
                (snapshot.mean_soil_glucose + snapshot.mean_soil_ammonium).min(10.0);
...
impl MultiObjectiveFitness {
    ...
    pub fn evaluate(
        snapshot: &TerrariumWorldSnapshot,
        periodic: &[TerrariumWorldSnapshot],
    ) -> Self {
        Self {
            ...
            fly_metabolism: evaluate_fitness(
                FitnessObjective::MaxFlyMetabolism,
                snapshot,
                periodic,
            ),
            enzyme_efficacy: evaluate_fitness(
                FitnessObjective::MaxEnzymeEfficacy,
                snapshot,
                periodic,
            ),
            ecosystem_integrity: evaluate_fitness(
                FitnessObjective::MaxEcosystemIntegrity,
                snapshot,
                periodic,
            ),
...
pub fn telemetry_from_result(
    result: &EvolutionResult,
    mode: Option<&str>,
) -> Vec<GenerationTelemetry> {
    result
        .generations
        .iter()
        .map(|gen| {
...
pub fn evaluate_stress_metrics_for_best(
    ...
    let sr =
        run_single_world_stressed(result.global_best_genome.clone(), frames, lite, &stress).ok()?;
...
pub fn run_generation(
    ...
    for genome in genomes {
        ...
        std::thread::spawn(move || {
            let result =
                run_single_world(genome, frames, snapshot_interval, fitness_objective, lite);
...
pub fn evolve(config: EvolutionConfig) -> Result<EvolutionResult, String> {
    ...
    for gen in 0..config.generations {
        ...
        let mut world_results: Vec<WorldResult> =
        ...
        let gen_mean_fitness =
            world_results.iter().map(|r| r.fitness).sum::<f32>() / world_results.len() as f32;
...
pub fn evolve_stress_test(config: EvolutionConfig) -> Result<EvolutionResult, String> {
    ...
    for gen in 0..config.generations {
        ...
        let results: Vec<StressTestResult> = rx.iter().filter_map(|r| r.ok()).collect();
        ...
        sorted_results.sort_by(|a, b| {
            b.resilience_fitness
                .partial_cmp(&a.resilience_fitness)
                .unwrap_or(std::cmp::Ordering::Equal)
        });
        ...
        let gen_mean_fitness = sorted_results
            .iter()
            .map(|r| r.resilience_fitness)
            .sum::<f32>()
...
fn compute_crowding_distance(results: &mut [ParetoResult]) {
    ...
    for obj_fn in objectives {
        ...
        results
            .first_mut()
            .map(|r| r.crowding_distance = f32::INFINITY);
        results
            .last_mut()
            .map(|r| r.crowding_distance = f32::INFINITY);
...
pub fn evolve_pareto(config: EvolutionConfig) -> Result<ParetoEvolutionResult, String> {
    ...
    for gen in 0..config.generations {
        ...
        for genome in population.clone() {
            ...
            std::thread::spawn(move || {
                let result =
                    run_single_world_multiobjective(genome, frames, snapshot_interval, lite);
                let _ = tx.send(result);
            });
        }
        drop(tx);

        let mut results: Vec<ParetoResult> = rx.iter().filter_map(|r| r.ok()).collect();
    ...
    let pareto_front: Vec<ParetoResult> =
        final_results.into_iter().filter(|r| r.rank == 0).collect();
...
pub fn telemetry_from_pareto_result(result: &ParetoEvolutionResult) -> GenerationTelemetry {
    ...
    let best = result
        ...
        .iter()
        .max_by(|a, b| {
            let a_sum = a.objectives.biomass
                + a.objectives.biodiversity
                + a.objectives.stability
                + a.objectives.carbon
                + a.objectives.fruit
                + a.objectives.microbial;
            let b_sum = b.objectives.biomass
                + b.objectives.biodiversity
                + b.objectives.stability
                + b.objectives.carbon
                + b.objectives.fruit
                + b.objectives.microbial;
            a_sum
                .partial_cmp(&b_sum)
                .unwrap_or(std::cmp::Ordering::Equal)
        })
    ...
    let sum = best.objectives.biomass
        + best.objectives.biodiversity
        + best.objectives.stability
        + best.objectives.carbon
        + best.objectives.fruit
        + best.objectives.microbial;
...
impl FlyPhenotypicNoise {
    ...
    pub fn from_stochastic_state(
        ...
        let trehalase_modifier =
            (protein_ratio * (1.0 + noise_scale * 0.1 * (rng.next_f32() - 0.5))).clamp(0.3, 3.0);
...
pub fn generate_population_noise(
    ...
    use crate::whole_cell::stochastic_expression::{
        step_stochastic_expression, StochasticExpressionConfig, StochasticOperonState,
        StochasticRng,
    };
    ...
    operons
        ...
        .enumerate()
        .map(|(i, operon)| {
            FlyPhenotypicNoise::from_stochastic_state(
                operon.fano_factor,
                operon.protein_count,
                noise_intensity,
...
pub fn bet_hedging_fitness(
    ...
    if noise_profiles.is_empty() {
        return snapshot.flies as f32;
    }

    let survival_score = snapshot.flies as f32 * 5.0;

    let rates: Vec<f32> = noise_profiles
        .iter()
        .map(|p| p.metabolic_rate_modifier)
        .collect();
    ...
    let persister_count = noise_profiles
        .iter()
        .filter(|p| p.dormancy_propensity > 0.2)
        .count();
...
impl PersisterCellSimulator {
    pub fn with_switching_rates(to_persister: f32, to_normal: f32) -> Self {
        Self {
            switch_to_persister_rate: to_persister,
            switch_to_normal_rate: to_normal,
            ..Default::default()
        }
    }

    pub fn apply_antibiotic(&mut self) {
        self.antibiotic_active = true;
    }
    pub fn remove_antibiotic(&mut self) {
        self.antibiotic_active = false;
    }
    ...
    pub fn step(&mut self, dt_hours: f32) {
        ...
        let antibiotic_kill = if self.antibiotic_active {
            n * self.antibiotic_kill_rate * dt_hours
        } else {
            0.0
        };
        ...
        self.normal_cells = (n + normal_growth - normal_to_persister + persister_to_normal
            - antibiotic_kill)
            .max(0.0);
        self.persister_cells =
            (p + persister_growth + normal_to_persister - persister_to_normal).max(0.0);
        ...
        self.history.push(PersisterSnapshot {
            ...
            persister_cells: self.persister_cells,
            total_cells: total,
            persister_fraction: if total > 0.0 {
                self.persister_cells / total
            } else {
                0.0
            },
    ...
    pub fn run_treatment_protocol(
        ...
        let pre_persister_frac = if pre_treatment_total > 0.0 {
            self.persister_cells / pre_treatment_total
        } else {
            0.0
        };
        ...
        let survival_fraction = if pre_treatment_total > 0.0 {
            post_treatment_total / pre_treatment_total
        } else {
            0.0
        };
        ...
        let regrowth_ratio = if min_total > 0.0 {
            post_recovery_total / min_total
        } else {
            0.0
        };
        ...
        PersisterTreatmentResult {
            pre_treatment_total,
            pre_treatment_persister_fraction: pre_persister_frac,
            post_treatment_total,
            survival_fraction,
            minimum_population: min_total,
            post_recovery_total,
            regrowth_ratio,
            total_time_hours: self.time_hours,
            biphasic_kill: biphasic,
        }
    }

    fn detect_biphasic_kill(&self) -> bool {
        let treatment_snapshots: Vec<&PersisterSnapshot> = self
            .history
            .iter()
            .filter(|s| s.antibiotic_active)
            .collect();
        if treatment_snapshots.len() < 4 {
            return false;
        }
        ...
        let late_rate = if treatment_snapshots[mid].total_cells > 0.0 {
            (treatment_snapshots.last().unwrap().total_cells / treatment_snapshots[mid].total_cells)
                .ln()
        } else {
            0.0
        };
...
impl BetHedgingGenome {
    ...
    pub fn crossover(a: &Self, b: &Self, rng: &mut StdRng) -> Self {
        Self {
            ...
            noise_intensity: if rng.gen::<f32>() < 0.5 {
                a.noise_intensity
            } else {
                b.noise_intensity
            },
            persister_rate_scale: if rng.gen::<f32>() < 0.5 {
                a.persister_rate_scale
            } else {
                b.persister_rate_scale
            },
            noise_tolerance: if rng.gen::<f32>() < 0.5 {
                a.noise_tolerance
            } else {
                b.noise_tolerance
            },
    ...
    pub fn mutate(&mut self, rng: &mut StdRng, rate: f32) {
        ...
        if rng.gen::<f32>() < rate {
            self.noise_intensity =
                (self.noise_intensity + rng.gen_range(-0.1..0.1)).clamp(0.0, 1.0);
        }
        if rng.gen::<f32>() < rate {
            self.persister_rate_scale =
                (self.persister_rate_scale * (1.0 + rng.gen_range(-0.2..0.2))).clamp(0.1, 10.0);
        }
        if rng.gen::<f32>() < rate {
            self.noise_tolerance =
                (self.noise_tolerance + rng.gen_range(-0.1..0.1)).clamp(0.0, 1.0);
        }
    }
}
...
pub fn evolve_bet_hedging(
    ...
    let mut population: Vec<BetHedgingGenome> = (0..population_size)
        .map(|_| BetHedgingGenome::random(&mut rng))
        .collect();
    ...
    for gen in 0..generations {
        ...
        for genome in &population {
            ...
            let noise_profiles = generate_population_noise(
                snapshot.flies.max(genome.base.fly_count),
                genome.noise_intensity,
                genome.base.seed,
            );
        ...
        let gen_wall_time = gen_start.elapsed().as_secs_f32() * 1000.0;
        eprintln!(
            "[bet-hedging gen {}/{}] best={:.2} mean={:.2} noise={:.3} ({:.0}ms)",
            gen + 1,
            generations,
            best_fitness,
            mean_fitness,
            population[best_idx].noise_intensity,
            gen_wall_time
        );
        ...
        if gen + 1 < generations {
            ...
            let mut next_gen = Vec::with_capacity(population_size);
            for &(idx, _) in indexed.iter().take(2) {
...
pub struct BetHedgingGenerationResult {
    ...
    pub best_fitness: f32,
    pub mean_fitness: f32,
    pub best_noise_intensity: f32,
    pub best_persister_rate: f32,
    pub wall_time_ms: f32,
}
...
impl EnvironmentalState {
    ...
    pub fn sample(&mut self, time_s: f32) -> EnvironmentalSample {
        ...
        let seasonal_hum =
            s.base_humidity + s.humidity_amplitude * (phase + std::f32::consts::FRAC_PI_2).sin();
        ...
        if self.active_drought.is_none() && self.rng.gen::<f32>() < s.drought_probability {
            let dur = self
                .rng
                .gen_range(s.drought_duration_range_s.0..=s.drought_duration_range_s.1);
        ...
        let drought_factor = if let Some(d) = &self.active_drought {
            1.0 - d.severity
        } else {
            1.0
        };
...
impl EnvironmentalSchedule {
    ...
    pub fn tropical() -> Self {
        Self {
            base_temperature_c: 28.0,
            seasonal_amplitude_c: 3.0,
            base_humidity: 0.80,
            humidity_amplitude: 0.10,
            drought_probability: 0.003,
            ..Self::default()
        }
    }
    ...
    pub fn arid() -> Self {
        Self {
            ...
            base_humidity: 0.25,
            humidity_amplitude: 0.10,
            drought_probability: 0.005,
            weather_noise_temp_c: 4.0,
            ..Self::default()
        }
    }
}
...
pub fn generate_spatial_zones(
    ...
    let zone_types = [
        ...
        ZoneType::Tropical,
        ZoneType::Temperate,
        ZoneType::NutrientRich,
        ZoneType::NutrientPoor,
    ];
    ...
    for r in 0..rows {
        for c in 0..cols {
            ...
            zones.push(SpatialZone {
                x_start: c * cw,
                y_start: r * ch,
                x_end: ((c + 1) * cw).min(width),
                y_end: ((r + 1) * ch).min(height),
                temperature_modifier: temp,
                moisture_modifier: moist,
                nutrient_modifier: nutr,
                light_modifier: light,
                zone_type: zt,
            });
        }
    }
...
impl Default for PlantPhenotypicNoise {
    fn default() -> Self {
        Self {
            ...
            photosynthetic_efficiency: 1.0,
            root_depth_modifier: 1.0,
        }
    }
}
...
impl Default for MicrobialPhenotypicNoise {
    fn default() -> Self {
        Self {
            ...
            biofilm_propensity: 0.0,
            sporulation_threshold: 0.5,
        }
    }
}
    ...
    (0..count)
        .map(|_| {
            ...
            PlantPhenotypicNoise {
                ...
                photosynthetic_efficiency: (1.0 + noise_intensity * 0.1 * (rng.next_f32() - 0.5))
                    .clamp(0.5, 1.5),
                root_depth_modifier: (1.0 + noise_intensity * 0.2 * (rng.next_f32() - 0.5))
                    .clamp(0.5, 2.0),
            }
        })
        .collect()
...
pub fn generate_microbial_noise(
    ...
    let mut rng = StochasticRng::new(seed);
    (0..count)
        .map(|_| MicrobialPhenotypicNoise {
            growth_rate_modifier: (noise_intensity * 0.15 * (rng.next_f32() - 0.5) * 2.0)
                .exp()
                .clamp(0.5, 2.0),
...
pub fn multi_species_bet_hedging_fitness(
    ...
    let microbe_diversity = if microbial_noise.len() > 1 {
        let biofilm_count = microbial_noise
            .iter()
            .filter(|m| m.biofilm_propensity > 0.3)
            .count();
        let resistant_count = microbial_noise
            .iter()
            .filter(|m| m.antibiotic_resistance > 0.1)
            .count();
    ...
    fly_score
        + plant_cv * 15.0
        + microbe_diversity * 20.0
        + snapshot.total_plant_cells * 0.01
        + snapshot.mean_microbes * 5.0
}
...
impl DrugProtocol {
    ...
    pub fn single(kill_rate: f32, treatment_hours: f32) -> Self {
        Self {
            cycles: vec![DrugCycle {
                drug_kill_rate: kill_rate,
                treatment_hours,
                rest_hours: 0.0,
            }],
    ...
    pub fn combination(kill_rate_a: f32, kill_rate_b: f32, hours_each: f32) -> Self {
        Self {
            cycles: vec![
                DrugCycle {
                    drug_kill_rate: kill_rate_a,
                    treatment_hours: hours_each,
                    rest_hours: 1.0,
                },
                DrugCycle {
                    drug_kill_rate: kill_rate_b,
                    treatment_hours: hours_each,
                    rest_hours: 0.0,
                },
            ],
    ...
    pub fn execute(&self, sim: &mut PersisterCellSimulator, dt: f32) -> DrugProtocolResult {
        ...
        DrugProtocolResult {
            ...
            survival_fraction: if pre_total > 0.0 {
                final_pop / pre_total
            } else {
                0.0
            },
...
pub fn optimize_drug_protocol(
    ...
    let results: Vec<DrugProtocolResult> = protocols
        .iter()
        .map(|protocol| {
    ...
    let best_idx = results
        ...
        .min_by(|(_, a), (_, b)| {
            a.final_population
                .partial_cmp(&b.final_population)
                .unwrap_or(std::cmp::Ordering::Equal)
        })
        .map(|(i, _)| i)
        .unwrap_or(0);
...
pub fn validate_against_ecoli() -> Vec<(f32, f32, f32, bool)> {
    ecoli_validation_data()
        .iter()
        .map(|&(switch_rate, expected)| {
...
impl GeneCircuitParams {
    ...
    pub fn mutate(&mut self, rng: &mut StdRng, rate: f32) {
        if rng.gen::<f32>() < rate {
            self.promoter_on_rate =
                (self.promoter_on_rate * (1.0 + rng.gen_range(-0.3..0.3))).clamp(0.001, 0.5);
        }
        if rng.gen::<f32>() < rate {
            self.promoter_off_rate =
                (self.promoter_off_rate * (1.0 + rng.gen_range(-0.3..0.3))).clamp(0.01, 1.0);
        }
        if rng.gen::<f32>() < rate {
            self.burst_size = (self.burst_size + rng.gen_range(-2.0..2.0)).clamp(1.0, 30.0);
        }
        if rng.gen::<f32>() < rate {
            self.transcription_rate =
                (self.transcription_rate * (1.0 + rng.gen_range(-0.3..0.3))).clamp(0.01, 2.0);
        }
    }
    ...
    pub fn predicted_mean_protein(&self) -> f32 {
        let mean_mrna = self.transcription_rate * self.promoter_on_rate
            / ((self.promoter_on_rate + self.promoter_off_rate) * self.mrna_degradation_rate)
                .max(1e-8);
...
pub fn optimize_gene_circuit(
    ...
    let mut population: Vec<GeneCircuitParams> = (0..population_size)
        .map(|_| GeneCircuitParams::random(&mut rng))
        .collect();

    let fitness_fn = |p: &GeneCircuitParams| -> f32 {
        let fano_err =
            ((p.predicted_fano() - spec.target_fano) / spec.target_fano.max(0.1)).powi(2);
        let mean_err = ((p.predicted_mean_protein() - spec.target_mean_protein)
            / spec.target_mean_protein.max(1.0))
        .powi(2);
...
pub fn evolve_with_environment(
    ...
    for gen in 0..config.generations {
        ...
        eprintln!(
            "  Gen {} | best={:.2} mean={:.2} | env={} | {:.1}s",
            gen,
            best.fitness,
            mean_fit,
            if schedule.drought_probability > 0.003 {
                "arid"
            } else if schedule.base_temperature_c > 26.0 {
                "tropical"
            } else {
                "temperate"
            },
...
impl SpeciesGenome {
    ...
    pub fn mutate(&mut self, rng: &mut StdRng, rate: f32) {
        ...
        if rng.gen::<f32>() < rate {
            self.defense_investment =
                (self.defense_investment + rng.gen_range(-0.1..0.1)).clamp(0.0, 1.0);
        }
        if rng.gen::<f32>() < rate {
            self.resource_efficiency =
                (self.resource_efficiency + rng.gen_range(-0.1..0.1)).clamp(0.1, 1.0);
        }
        if rng.gen::<f32>() < rate {
            self.cooperation_tendency =
                (self.cooperation_tendency + rng.gen_range(-0.1..0.1)).clamp(0.0, 1.0);
        }
        if rng.gen::<f32>() < rate {
            self.mobility = (self.mobility + rng.gen_range(-0.1..0.1)).clamp(0.1, 1.0);
        }
    }
    ...
    pub fn crossover(a: &Self, b: &Self, rng: &mut StdRng) -> Self {
        Self {
            ...
            defense_investment: if rng.gen() {
                a.defense_investment
            } else {
                b.defense_investment
            },
            resource_efficiency: if rng.gen() {
                a.resource_efficiency
            } else {
                b.resource_efficiency
            },
            cooperation_tendency: if rng.gen() {
                a.cooperation_tendency
            } else {
                b.cooperation_tendency
            },
...
pub fn evaluate_coevolution_pair(
    ...
    let wr_a = run_single_world(
        a.world_genome.clone(),
        frames,
        10,
        FitnessObjective::MaxBiomass,
        lite,
    ...
    let wr_b = run_single_world(
        b.world_genome.clone(),
        frames,
        10,
        FitnessObjective::MaxBiomass,
        lite,
    ...
    let (fit_a, fit_b, interaction) = match mode {
        CoevolutionMode::RedQueen => {
            ...
            (
                net_a,
                net_b,
                (attack_a - def_b).abs() + (attack_b - def_a).abs(),
            )
        }
        ...
        CoevolutionMode::Competitive => {
            ...
            let share_a = if total > 0.0 {
                a.resource_efficiency / total
            } else {
                0.5
            };
            let share_b = 1.0 - share_a;
            (
                wr_a.fitness * share_a * 2.0,
                wr_b.fitness * share_b * 2.0,
                (share_a - share_b).abs(),
            )
        }
    };
...
pub fn evolve_coevolution(
    ...
    let start = Instant::now();
    let mut rng = StdRng::seed_from_u64(seed);
    let mut pop_a: Vec<SpeciesGenome> = (0..pop_size)
        .map(|_| SpeciesGenome::random(&mut rng))
        .collect();
    let mut pop_b: Vec<SpeciesGenome> = (0..pop_size)
        .map(|_| SpeciesGenome::random(&mut rng))
        .collect();
    ...
    for gen in 0..generations {
        ...
        eprintln!(
            "  CoEvo Gen {} | A: best={:.2} mean={:.2} | B: best={:.2} mean={:.2}",
        ...
        history.push(CoevolutionGeneration {
            ...
            mean_fitness_a: mean_a,
            best_fitness_b: best_b,
            mean_fitness_b: mean_b,
        });
        ...
        // Elitism: keep best
        let best_a_idx = fit_a
            .iter()
            .enumerate()
            .max_by(|a, b| a.1.partial_cmp(b.1).unwrap())
            .unwrap()
            .0;
        let best_b_idx = fit_b
            .iter()
            .enumerate()
            .max_by(|a, b| a.1.partial_cmp(b.1).unwrap())
            .unwrap()
...
pub fn assess_ecosystem_health(snapshots: &[TerrariumWorldSnapshot]) -> EcosystemHealthReport {
    ...
    if latest.plants > 0 {
        abundances.push(latest.total_plant_cells);
    }
    if latest.flies > 0 {
        abundances.push(latest.flies as f32 * 10.0);
    }
    if latest.mean_microbes > 0.001 {
        abundances.push(latest.mean_microbes * 100.0);
    }
    if latest.fruits > 0 {
        abundances.push(latest.fruits as f32);
    }
    if latest.seeds > 0 {
        abundances.push(latest.seeds as f32);
    }
    if latest.mean_symbionts > 0.001 {
        abundances.push(latest.mean_symbionts * 50.0);
    }
    ...
    let total_biomass =
        latest.total_plant_cells + latest.flies as f32 * 10.0 + latest.mean_microbes * 100.0;

    let total_energy =
        latest.mean_soil_atp_flux * 100.0 + latest.avg_fly_energy * latest.flies as f32;

    let biomass_metabolism = if total_energy > 0.0 {
        total_biomass / total_energy
    } else {
        0.0
    };
    ...
    let var_biomass = biomass_series
        .iter()
        .map(|b| (b - mean_biomass).powi(2))
        .sum::<f32>()
        / biomass_series.len() as f32;
    let cv = if mean_biomass > 0.0 {
        var_biomass.sqrt() / mean_biomass
    } else {
        1.0
    };
    ...
    if biomass_series.len() > 10 {
        ...
        let second_half_mean =
            biomass_series[mid..].iter().sum::<f32>() / (biomass_series.len() - mid) as f32;
...
pub fn run_and_export(
    ...
    let health = if snapshots.len() >= 3 {
        Some(assess_ecosystem_health(&snapshots))
    } else {
        None
    };
...
pub fn ecosystem_dashboard(snapshots: &[TerrariumWorldSnapshot], width: usize) -> String {
    ...
    if snapshots.len() >= 3 {
        ...
        out.push_str(&format!("{:-<w$}\n", "- Health ", w = w));
        out.push_str(&format!(
            "  Shannon H':  {:.3}  Simpson D: {:.3}  Evenness: {:.3}\n",
            health.shannon_diversity, health.simpson_diversity, health.evenness
        ));
        out.push_str(&format!(
            "  Trophic: {}  Stability: {:.2}  Resilience: {:.2}\n",
...
fn apply_param(genome: &mut WorldGenome, param_idx: usize, value: f32) {
    fn denorm(value: f32, lo: f32, hi: f32) -> f32 {
        lo + value.clamp(0.0, 1.0) * (hi - lo)
    }
    ...
    match param_idx {
        0 => {
            genome.initial_proton_scale = denorm(
                value,
                GenomeRange::PROTON_SCALE.0,
                GenomeRange::PROTON_SCALE.1,
            )
        ...
        1 => {
            genome.soil_temperature_c = denorm(
                value,
                GenomeRange::TEMPERATURE.0,
                GenomeRange::TEMPERATURE.1,
            )
        ...
        2 => {
            genome.water_source_count = denorm_usize(
                value,
                GenomeRange::WATER_COUNT.0,
                GenomeRange::WATER_COUNT.1,
            )
        ...
        4 => {
            genome.initial_moisture_scale = denorm(
                value,
                GenomeRange::MOISTURE_SCALE.0,
                GenomeRange::MOISTURE_SCALE.1,
            )
        ...
        5 => {
            genome.plant_count = denorm_usize(
                value,
                GenomeRange::PLANT_COUNT.0,
                GenomeRange::PLANT_COUNT.1,
            )
        ...
        6 => {
            genome.fruit_count = denorm_usize(
                value,
                GenomeRange::FRUIT_COUNT.0,
                GenomeRange::FRUIT_COUNT.1,
            )
        ...
        7 => {
            genome.fly_count =
                denorm_usize(value, GenomeRange::FLY_COUNT.0, GenomeRange::FLY_COUNT.1)
        }
        8 => {
            genome.microbe_cohort_count = denorm_usize(
                value,
                GenomeRange::MICROBE_COUNT.0,
                GenomeRange::MICROBE_COUNT.1,
            )
        ...
        9 => {
            genome.fly_psc_scale = denorm(value, GenomeRange::PSC_SCALE.0, GenomeRange::PSC_SCALE.1)
        }
        10 => {
            genome.fly_neural_steps = denorm(
                value,
                GenomeRange::NEURAL_STEPS.0 as f32,
                GenomeRange::NEURAL_STEPS.1 as f32,
            ) as u32
        ...
        11 => {
            genome.respiration_vmax_scale =
                denorm(value, GenomeRange::VMAX_SCALE.0, GenomeRange::VMAX_SCALE.1)
        }
        12 => {
            genome.nitrification_vmax_scale =
                denorm(value, GenomeRange::VMAX_SCALE.0, GenomeRange::VMAX_SCALE.1)
        }
        13 => {
            genome.photosynthesis_vmax_scale =
                denorm(value, GenomeRange::VMAX_SCALE.0, GenomeRange::VMAX_SCALE.1)
        }
        14 => {
            genome.mineralization_vmax_scale =
                denorm(value, GenomeRange::VMAX_SCALE.0, GenomeRange::VMAX_SCALE.1)
        }
        15 => genome.time_warp = denorm(value, GenomeRange::TIME_WARP.0, GenomeRange::TIME_WARP.1),
        16 => {
            genome.enzyme_probe_x =
                denorm(value, GenomeRange::ENZYME_POS.0, GenomeRange::ENZYME_POS.1)
        }
        17 => {
            genome.enzyme_probe_y =
                denorm(value, GenomeRange::ENZYME_POS.0, GenomeRange::ENZYME_POS.1)
        }
        _ => {}
    }
...
pub fn scan_fitness_landscape(
    ...
    for yi in 0..res {
        for xi in 0..res {
            ...
            fitness.push(f);
            if f > peak.2 {
                peak = (x_values[xi], y_values[yi], f);
            }
        }
    }
    ...
    let x_name = PARAM_NAMES
        .get(x_axis.param_index)
        .unwrap_or(&"unknown")
        .to_string();
    let y_name = PARAM_NAMES
        .get(y_axis.param_index)
        .unwrap_or(&"unknown")
        .to_string();
    FitnessLandscape {
        x_param: x_name,
...
impl FitnessLandscape {
    ...
    pub fn to_ascii(&self, width: usize) -> String {
        ...
        out.push_str(&format!(
            "Fitness Landscape: {} vs {}\n",
            self.x_param, self.y_param
        ));
        out.push_str(&format!(
            "Objective: {}  Peak: ({:.2}, {:.2}) = {:.4}\n",
        ...
        for row in (0..h).rev() {
            ...
            if row % 5 == 0 {
                out.push_str(&format!(
                    "{:.2}|",
                    self.y_values[yi.min(self.resolution - 1)]
                ));
            } else {
                out.push_str("    |");
            }
            for col in 0..w {
                ...
                let idx =
                    yi.min(self.resolution - 1) * self.resolution + xi.min(self.resolution - 1);
...
pub fn telemetry_to_csv(records: &[GenerationTelemetry]) -> String {
    ...
    out.push_str(
        "generation,best_fitness,mean_fitness,worst_fitness,population_diversity,elapsed_ms,mode",
    );
...
mod tests {
    ...
    fn pareto_ranks_computed_correctly() {
        ...
        assert!(
            results[2].rank < results[0].rank,
            "Best solution should have lower rank than first"
        );
        assert!(
            results[2].rank < results[1].rank,
            "Best solution should have lower rank than second"
        );
    ...
    fn fly_metabolism_fitness_evaluates() {
        ...
        if snapshot.flies > 0 {
            assert!(
                fitness > 0.0,
                "MaxFlyMetabolism should be > 0 with flies, got {fitness}"
            );
        }
        // Multi-objective should include fly_metabolism.
        let multi = MultiObjectiveFitness::evaluate(&snapshot, &[]);
        assert!(
            multi.fly_metabolism >= 0.0,
            "fly_metabolism objective should be non-negative"
        );
    }
    ...
    fn phenotypic_noise_from_stochastic_produces_variation() {
        ...
        assert!(
            variance > 0.001,
            "Phenotypic noise should produce variance, got {variance:.6}"
        );
    ...
    fn generate_population_noise_high_intensity_produces_variation() {
        ...
        assert!(
            variance > 0.0,
            "High noise intensity should produce variance"
        );
    }
    ...
    fn bet_hedging_fitness_rewards_flies() {
        let snapshot = TerrariumWorldSnapshot {
            ...
            temperature: 25.0,
            humidity: 0.7,
            mean_soil_moisture: 0.5,
            mean_deep_moisture: 0.3,
            mean_litter_cover_fraction: 0.1,
            mean_litter_surface_depth_mm: 0.02,
            mean_microbes: 100.0,
            mean_symbionts: 50.0,
            mean_canopy: 0.8,
            mean_root_density: 0.3,
            total_plant_cells: 100.0,
            mean_cell_vitality: 0.8,
            mean_cell_energy: 0.5,
            mean_division_pressure: 0.3,
            mean_soil_glucose: 1.0,
            mean_soil_oxygen: 0.2,
            mean_soil_ammonium: 0.1,
            mean_soil_nitrate: 0.05,
            mean_soil_redox: 0.3,
            mean_soil_atp_flux: 0.5,
            mean_atmospheric_co2: 400.0,
            mean_atmospheric_o2: 0.21,
            ecology_event_count: 5,
            avg_fly_energy_charge: 0.85,
            fly_plant_proximity_mean: 3.0,
            fly_altitude_mean: 1.5,
            fly_o2_gradient_correlation: 0.3,
            owned_fraction: 0.2,
            substrate_backend: String::from("cpu"),
            substrate_steps: 100,
            substrate_time_ms: 10.0,
            time_s: 1.0,
            atomistic_probes: 0,
            ..Default::default()
        };
        ...
        assert!(
            fitness > 20.0,
            "Fitness should be > 20 with 4 flies, got {fitness:.2}"
        );
    }
    ...
    fn persister_cells_survive_antibiotic() {
        ...
        assert!(
            result.pre_treatment_total > 1e6,
            "Pre-treatment population should exceed initial, got {:.0}",
            result.pre_treatment_total
        );

        // Post-treatment: massive kill but persisters survive
        assert!(
            result.post_treatment_total > 0.0,
            "Persisters should survive antibiotic treatment"
        );
        assert!(
            result.survival_fraction < 0.1,
            "Most cells should be killed, survival={:.4}",
            result.survival_fraction
        );

        // Recovery: population should regrow from persisters
        assert!(
            result.post_recovery_total > result.minimum_population,
            "Population should recover after antibiotic removal"
        );
        assert!(
            result.regrowth_ratio > 1.0,
            "Regrowth ratio should > 1, got {:.2}",
            result.regrowth_ratio
        );
    }
    ...
    fn persister_switching_rates_affect_survival() {
        ...
        assert!(
            ...
            result_high.survival_fraction,
            result_low.survival_fraction
        );
    }
    ...
    fn nsga2_breed_preserves_population_size() {
        ...
        assert_eq!(
            pop.len(),
            8,
            "Breeding must produce exactly population_size genomes"
        );
    }
    ...
    fn stressed_multi_fitness_evaluates_under_perturbation() {
        ...
        match result {
            Ok((pareto, metrics)) => {
                ...
                assert!(
                    metrics.min_stress_biomass <= metrics.pre_stress_biomass + 1.0,
                    "min_stress={:.2} should be <= pre_stress={:.2}",
                    metrics.min_stress_biomass,
                    metrics.pre_stress_biomass
                );
            }
            Err(e) => {
                // Acceptable: lite world may fail to construct with some genomes
                eprintln!(
                    "  Stressed multi-fitness construction failed (ok for edge-case genome): {e}"
                );
            }
        }
    }
    ...
    fn stress_config_from_frames_scales_correctly() {
        ...
        assert!(
            stress.drought_frame + stress.perturbation_duration <= stress.heat_spike_frame,
    ...
    fn seasonal_temperature_oscillates() {
        ...
        assert!(
            avg_sum > avg_win,
            "Summer ({avg_sum:.1}) should be warmer than winter ({avg_win:.1})"
        );
    }
    ...
    fn drought_reduces_moisture() {
        ...
        assert!(
            sample.moisture_modifier < 1.0,
            "Drought should reduce moisture"
        );
    }
    ...
    fn spatial_fitness_modifier_varies() {
        ...
        assert!(
            rich > poor,
            "Nutrient-rich zone should have higher modifier"
        );
    }
    ...
    fn generate_microbial_noise_produces_variation() {
        ...
        assert!(
            has_resistant || has_biofilm,
            "Microbial noise should produce phenotypic variety"
        );
    }
    ...
    fn multi_species_fitness_rewards_diversity() {
        ...
        let fitness = multi_species_bet_hedging_fitness(
            &snapshot,
            &fly_noise,
            &plant_noise,
            &microbial_noise,
    ...
    fn single_drug_protocol_kills_cells() {
        ...
        assert!(
            result.survival_fraction < 0.5,
            "Single drug should kill most cells"
        );
    ...
    fn protocol_optimizer_finds_best() {
        ...
        assert!(
            results[best_idx].final_population <= results[0].final_population,
    ...
    fn circuit_optimization_converges() {
        ...
        assert!(
            result.achieved_fano > 1.0,
            "Should achieve super-Poisson noise"
        );
    ...
    fn evolve_with_environment_temperate() {
        ...
        assert!(
            result.global_best_fitness > 0.0,
            "Should find positive fitness"
        );
    ...
    fn evolve_with_environment_arid_is_harder() {
        ...
        let temperate =
            evolve_with_environment(config.clone(), EnvironmentalSchedule::temperate()).unwrap();
    ...
    fn coevolution_mutualistic_boosts_fitness() {
        ...
        let result =
            evaluate_coevolution_pair(&a, &b, CoevolutionMode::Mutualistic, 20, true).unwrap();
        // Mutualistic with max cooperation should boost both
        assert!(
            result.interaction_strength > 0.5,
            "High cooperation species should have strong interaction"
        );
    }
    ...
    fn coevolution_competitive_splits_resources() {
        ...
        let result =
            evaluate_coevolution_pair(&a, &b, CoevolutionMode::Competitive, 20, true).unwrap();
        // With identical worlds, the 9x more efficient species should get 9x share
        assert!(
            result.species_a_fitness > result.species_b_fitness,
            "Efficient species should outcompete: a={:.2} b={:.2}",
            result.species_a_fitness,
            result.species_b_fitness
        );
    }
    ...
    fn grn_evolution_converges() {
        ...
        assert!(
            result.best_phenotype.growth_rate > 0.0,
            "Should produce growth"
        );
    }
    ...
    fn prometheus_export_has_metrics() {
        let records = vec![GenerationTelemetry {
            generation: 0,
            best_fitness: 3.14,
            mean_fitness: 2.0,
            worst_fitness: 1.0,
    ...
    fn landscape_scan_produces_grid() {
        ...
        let landscape =
            scan_fitness_landscape(&base, x_axis, y_axis, FitnessObjective::MaxBiomass, 3, 5);
