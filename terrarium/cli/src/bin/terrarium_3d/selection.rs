...
impl Selection {
    ...
    pub fn update_cycle_list(&mut self, plants: usize, flies: usize, waters: usize, fruits: usize) {
        ...
        for i in 0..plants {
            self.cycle_list.push(EntityTag::Plant(i));
        }
        for i in 0..flies {
            self.cycle_list.push(EntityTag::Fly(i));
        }
        for i in 0..waters {
            self.cycle_list.push(EntityTag::Water(i));
        }
        for i in 0..fruits {
            self.cycle_list.push(EntityTag::Fruit(i));
        }
    }
