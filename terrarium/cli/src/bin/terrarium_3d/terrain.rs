...
use super::color::{
    chemistry_v3, elevation_v3, heatmap_v3, organic_v3, soil_color_v3, substrate_co2_v3,
    substrate_glucose_v3, substrate_nitrogen_v3, substrate_o2_v3, OverlayMode,
};
use super::math::*;
...
pub fn build_terrain_mesh_overlay(world: &TerrariumWorld, overlay: OverlayMode) -> Vec<Triangle> {
    ...
    let mut tris: Vec<Triangle> = tri_indices
        .iter()
        .map(|&(a, b, c)| Triangle {
            v: [
                Vertex {
