...
use super::math::v3;
use super::mesh::{Triangle, Vertex, EntityTag};
...
pub fn build_water_meshes(world: &TerrariumWorld, seed: u64, frame_idx: usize) -> Vec<Triangle> {
    ...
    for (i, water) in world.waters.iter().enumerate() {
        ...
        tris.push(Triangle { v: [
            Vertex { pos: p0, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
            Vertex { pos: p1, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
            Vertex { pos: p2, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: p0, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
            Vertex { pos: p2, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
            Vertex { pos: p3, normal: n_up, color: WATER_COLOR, shininess: 64.0 },
        ], tag: EntityTag::Water(i) });
        ...
        tris.push(Triangle { v: [
            Vertex { pos: b0, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b2, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b1, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: b0, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b3, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b2, normal: n_down, color: WATER_COLOR_DEEP, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        ...
        tris.push(Triangle { v: [
            Vertex { pos: b0, normal: n_s, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b1, normal: n_s, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p0, normal: n_s, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: b1, normal: n_s, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p1, normal: n_s, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: p0, normal: n_s, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        ...
        tris.push(Triangle { v: [
            Vertex { pos: b3, normal: n_n, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p3, normal: n_n, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: p2, normal: n_n, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: b3, normal: n_n, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p2, normal: n_n, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: b2, normal: n_n, color: WATER_COLOR_DEEP, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });

        // West wall (x-)
        let n_w: [f32; 3] = [-1.0, 0.0, 0.0];
        tris.push(Triangle { v: [
            Vertex { pos: b0, normal: n_w, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p0, normal: n_w, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: p3, normal: n_w, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: b0, normal: n_w, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p3, normal: n_w, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: b3, normal: n_w, color: WATER_COLOR_DEEP, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });

        // East wall (x+)
        let n_e: [f32; 3] = [1.0, 0.0, 0.0];
        tris.push(Triangle { v: [
            Vertex { pos: b1, normal: n_e, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p2, normal: n_e, color: WATER_COLOR, shininess: 32.0 },
            Vertex { pos: p1, normal: n_e, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
        tris.push(Triangle { v: [
            Vertex { pos: b1, normal: n_e, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: b2, normal: n_e, color: WATER_COLOR_DEEP, shininess: 32.0 },
            Vertex { pos: p2, normal: n_e, color: WATER_COLOR, shininess: 32.0 },
        ], tag: EntityTag::Water(i) });
    }
    tris
