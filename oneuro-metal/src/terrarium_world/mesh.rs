...
pub(in crate::terrarium_world) fn normalize3(value: [f32; 3]) -> [f32; 3] {
...
pub(in crate::terrarium_world) fn sub3(a: [f32; 3], b: [f32; 3]) -> [f32; 3] {
    [a[0] - b[0], a[1] - b[1], a[2] - b[2]]
}

pub(in crate::terrarium_world) fn mul3(value: [f32; 3], scalar: f32) -> [f32; 3] {
    [value[0] * scalar, value[1] * scalar, value[2] * scalar]
}

pub(in crate::terrarium_world) fn dot3(a: [f32; 3], b: [f32; 3]) -> f32 {
    a[0] * b[0] + a[1] * b[1] + a[2] * b[2]
}

pub(in crate::terrarium_world) fn cross3(a: [f32; 3], b: [f32; 3]) -> [f32; 3] {
    [
        a[1] * b[2] - a[2] * b[1],
        a[2] * b[0] - a[0] * b[2],
        a[0] * b[1] - a[1] * b[0],
...
pub(in crate::terrarium_world) fn rotate_about_axis(value: [f32; 3], axis: [f32; 3], angle: f32) -> [f32; 3] {
...
pub(in crate::terrarium_world) fn mesh_orient_from_up(mesh: &mut TerrariumTriangleMeshRender, direction: [f32; 3]) {
    let up = [0.0, 1.0, 0.0];
...
pub(in crate::terrarium_world) fn bezier3(a: [f32; 3], b: [f32; 3], c: [f32; 3], d: [f32; 3], t: f32) -> [f32; 3] {
...
pub(in crate::terrarium_world) fn mesh_push_quad(
...
pub(in crate::terrarium_world) fn render_cuboid_mesh(size: [f32; 3]) -> TerrariumTriangleMeshRender {
...
pub(in crate::terrarium_world) fn render_quad_mesh(size: [f32; 2]) -> TerrariumTriangleMeshRender {
...
pub(in crate::terrarium_world) fn render_cylinder_mesh(
    radius: f32,
    height: f32,
    resolution: usize,
...
pub(in crate::terrarium_world) fn render_ellipsoid_mesh(
    radii: [f32; 3],
    sectors: usize,
    stacks: usize,
) -> TerrariumTriangleMeshRender {
...
pub(in crate::terrarium_world) fn render_segment_mesh(
    start: [f32; 3],
    end: [f32; 3],
    radius: f32,
    resolution: usize,
